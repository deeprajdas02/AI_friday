...
def wish():
    ...
    if hour>=0 and hour<12:
        reply("Good Morning Deepraj!")
    elif hour>=12 and hour<18:
        reply("Good Afternoon Deepraj!")   
    else:
        reply("Good Evening Deepraj")  
...
def respond(voice_data):
    ...
    if is_awake==False:
        ...
        reply('My name is friday and i am created by Mr. Deepraj')
    
    elif 'i love you' in voice_data:
        reply('I too love you Deepraj')
        ...
        try:
            ...
            reply('This is what I found Deepraj')
        except:
            reply('Please check your Internet')

    elif 'explain' in voice_data:
        reply("don't warry Deepraj, I will explain for you!")
        ...
        reply("Good bye Deepraj! Have a nice day.")
        is_awake = False
